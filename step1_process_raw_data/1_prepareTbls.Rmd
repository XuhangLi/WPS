...
# if any wrong RNAi is identified by the QC, confirm with Sanger sequencing, 
# then update the sample sheet and repeat this process using the following code. 
...
for (libID in 1:6){
  ...
  # save tables
  write.table(x = RNAiBCsheet,file = paste('./../data/RNAiBCsheets/RNAiBCsheet_met',plateID,'_lib',libID,'.csv',sep = ''),quote = F,sep = ',',row.names = F,col.names = F)
  write.table(x = bcTable,file =  paste('./../data/RNAiBCsheets/bcTable_met',plateID,'_lib',libID,'.txt',sep = ''),quote = F,sep = ':',row.names = F,col.names = F)
  write.table(x = sampleSheet,file = paste('./../data/sampleSheets/sampleSheet_met',plateID,'_lib',libID,'.txt',sep = ''),quote = F,sep = ',',row.names = F,col.names = F)
